...
class MeetingCommentServiceTest {
    ...
    void 댓글등록() {
        ...
        assertThat(result.get(0).getContent()).isEqualTo("모임 참가합니다.");
    ...
    void 댓글삭제() {
        ...
        MeetingComment meetingcomment2 = meetingCommentService.createComment(new MeetingCommentCreateRequestDto("1번", null), meeting1.getId(), userDetails1);
        MeetingComment meetingComment3 = new MeetingComment("되는건가?",user1,meeting1,null);
        ...
        assertThat(result.get(0).getContent()).isEqualTo("모임 참가합니다.");
        assertThat(result.get(1).getContent()).isEqualTo("1번");

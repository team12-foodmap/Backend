...
class MyPageServiceTest {
    ...
    void setup() {
        ...
        restaurantLikes2 = new RestaurantLikes(restaurantLikes2.getId(),user2, restaurant1);
        restaurantLikesRepository.save(restaurantLikes1);
        ...
        review2 = new Review(reviewRequestDto2, user2, restaurant2,"image1");
    ...
    class sucess {
        ...
        void 리뷰리스트() {
            ...
            assertThat(myReviewList.size()).isEqualTo(0);
